...
UI_TRANSLATIONS = {
    'en': {
        ...
        'resultDisease': 'Disease detected!',
    ...
    'ne': {
        ...
        'resultDisease': 'रोग पत्ता लाग्यो!',
...
# ============================================
# CARE INSTRUCTIONS (English + Nepali) - Cleaned without emojis
# ============================================
CARE_DATA = {
    "Rice - Brown Spot": {
        "en": {
            ...
            "prevention": "Use resistant varieties and maintain proper drainage",
            "safety_warnings": [
                "DO NOT water in the evening (increases fungal growth)",
                "DO NOT use same fungicide repeatedly (can cause resistance)",
        ...
        "ne": {
            ...
            "prevention": "प्रतिरोधी प्रजातिहरू प्रयोग गर्नुहोस् र राम्रो जल निकासी कायम राख्नुहोस्",
            "safety_warnings": [
                "साँझमा पानी नहाल्नुहोस् (फंगस बढ्न सक्छ)",
                "एउटै फंगिसाइड बारम्बार प्रयोग नगर्नुहोस् (प्रतिरोध हुन सक्छ)",
                "रसायन लगाउँदा सुरक्षा गियर लगाउनुहोस्"
            ],
    ...
    "Rice - Leaf Blast": {
        "en": {
            ...
            "prevention": "Use resistant varieties, proper spacing, and balanced fertilization",
            "safety_warnings": [
                "DO NOT apply excess nitrogen fertilizer",
                "DO NOT overcrowd plants",
                "DO NOT use infected seeds"
            ],
        ...
        "ne": {
            ...
            "prevention": "प्रतिरोधी प्रजातिहरू, उचित दूरी, र सन्तुलित मल प्रयोग गर्नुहोस्",
            "safety_warnings": [
                "अत्यधिक नाइट्रोजन मल नलगाउनुहोस्",
                "बिरुवाहरू धेरै नजिक नरोप्नुहोस्",
                "संक्रमित बीउहरू प्रयोग नगर्नुहोस्"
            ],
    ...
    "Rice - Neck Blast": {
        "en": {
            ...
            "prevention": "Use resistant varieties, practice crop rotation, and use disease-free seeds",
            "safety_warnings": [
                "DO NOT plant rice in same field consecutively",
                "DO NOT use infected seeds",
        ...
        "ne": {
            ...
            "prevention": "प्रतिरोधी प्रजातिहरू, बाली चक्रण, र रोग-मुक्त बीउहरू प्रयोग गर्नुहोस्",
            "safety_warnings": [
                "एउटै खेतमा लगातार धान नरोप्नुहोस्",
                "संक्रमित बीउहरू प्रयोग नगर्नुहोस्",
                "नाइट्रोजनको अत्यधिक मल नलगाउनुहोस्"
            ],
    ...
    "Rice - Healthy": {
        ...
        "ne": {
            ...
            "prevention": "राम्रो कृषि अभ्यास र नियमित निगरानी जारी राख्नुहोस्",
            "safety_warnings": [
    ...
    "Potato - Early Blight": {
        "en": {
            ...
            "prevention": "Use certified disease-free seed potatoes, practice crop rotation (3-4 years), and maintain proper drainage",
            "safety_warnings": [
                "DO NOT compost infected plant material",
                "DO NOT over-water",
                "DO NOT work in field when wet"
            ],
            "notice": "If stem lesions appear or >50% leaves affected, consult plant pathologist immediately - may spread to tubers"
        },
        "ne": {
            ...
            "prevention": "प्रमाणित रोग-मुक्त बीउ आलु प्रयोग गर्नुहोस्, बाली चक्रण (३-४ वर्ष) अभ्यास गर्नुहोस्, र राम्रो जल निकासी कायम राख्नुहोस्",
            "safety_warnings": [
                "संक्रमित बिरुवाको कम्पोस्ट नबनाउनुहोस्",
                "अत्यधिक पानी नदिनुहोस्",
                "खेत भिजेको बेला काम नगर्नुहोस्"
            ],
            "notice": "यदि डाँठमा घाउ देखिन्छ वा ५०% भन्दा बढी पातहरू प्रभावित छन् भने, तुरुन्त बिरुवा रोग विशेषज्ञसँग सम्पर्क गर्नुहोस् - आलुसम्म फैलिन सक्छ"
        }
    },
    "Potato - Late Blight": {
        "en": {
            ...
            "prevention": "Use resistant varieties, practice strict field hygiene, apply preventive fungicides before rainy season",
            "safety_warnings": [
                "DO NOT touch infected plants without gloves",
                "DO NOT compost infected plant material",
                "DO NOT work in wet fields - spreads through water"
            ],
        ...
        "ne": {
            ...
            "prevention": "प्रतिरोधी प्रजातिहरू प्रयोग गर्नुहोस्, कडा खेत सरसफाई अभ्यास गर्नुहोस्, वर्षायाम अघि रोकथाम फंगिसाइड लगाउनुहोस्",
            "safety_warnings": [
                "पन्जा बिना संक्रमित बिरुवाहरू नछुनुहोस्",
                "संक्रमित बिरुवाको कम्पोस्ट नबनाउनुहोस्",
                "भिजेको खेतमा काम नगर्नुहोस् - पानीबाट फैलिन्छ"
            ],
